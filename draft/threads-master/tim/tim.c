 ...
 *
 * Note that the thread must be alive for us to make the call. We cannot make
 * the call after a thread exits (the call will return an error).
 */
