...
plot 'Running Time Compare 3.csv' using 1:2:($3):($4) with yerrorlines title "CNF-SAT-VC" dt 1 lc 0 lt 16, \
     '' using 1:5:($6):($7) with yerrorlines title "Approx-1-VC" dt 2 lc 0 lt 32, \
     '' using 1:8:($9):($10) with yerrorlines title "Approx-2-VC" dt 3 lc 0 lt 32